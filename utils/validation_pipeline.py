...
if __name__ == "__main__":
    ...
    #     "ima": True,
    #     "hardness_min": 7.0,
    #     "hardness_max": 5.0,  # min > max - should fail
    #     "el_inc": "Fe"
    # }
    ...
    # async def test():
    #     print("=== Test 1: Valid params with case correction ===")
    #     result1 = await pipeline.validate(params1, "Find IMA minerals with hardness 3-5")
    #     print(json.dumps(result1, indent=2))
        
    #     print("\n=== Test 2: Invalid hardness range ===")
    #     result2 = await pipeline.validate(params2, "Find minerals")
